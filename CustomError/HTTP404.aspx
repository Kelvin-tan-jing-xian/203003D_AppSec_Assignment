<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HTTP404.aspx.cs" Inherits="_203003D_AppSec_Assignment.CustomError.HTTP404" %>
...
<body>
    ...
    <div class="text">
      ...
      <h2>Couldn't launch :(</h2>
         <h3>Page Not Found - lets take you <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/HomePage.aspx">BACK</asp:HyperLink>
         </h3> 
    </div>
    </form>
</body>
